...
import com.gameengine.system.exception.ExceptionMonitorType;
import com.gameengine.system.exception.GameLoginExceptionType;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class GameLoggerFactory {
    //协议日志
//    public static final Logger CMD_LOGGER = GameLoggerFactory.getLogger("CMD");
