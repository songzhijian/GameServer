...
import com.jx.config.loader.StageBattleConfigLoader;
...
*/
public class StageBattleConfig extends AbstractConfig implements IConfig {
    ...
    /**缩放3*/
    private final float scale3;
    /**缩放4*/
    private final float scale4;
    /**缩放5*/
    private final float scale5;
    /**缩放1*/
    private final float zscale1;
    /**缩放2*/
    private final float zscale2;
    /**缩放3*/
    private final float zscale3;
    /**缩放4*/
    private final float zscale4;
    /**缩放5*/
    private final float zscale5;
    /**士兵1*/
    ...
    public static List<StageBattleConfig> findAll(){
        return StageBattleConfigLoader.findAll();
    }
    ...
    public static StageBattleConfig getByKey(int key){
        return StageBattleConfigLoader.getByKey(key);
    }
    ...
    public StageBattleConfig(int id, int enemy1, int enemy2, int enemy3, int enemy4, int enemy5, int level1, int level2, int level3, int level4, int level5, int quality1, int quality2, int quality3, int quality4, int quality5, float scale1, float scale2, float scale3, float scale4, float scale5, float zscale1, float zscale2, float zscale3, float zscale4, float zscale5, int[][] navy1, int[][] navy2, int[][] navy3, int[][] navy4, int[][] navy5, int[][] equip1, int[][] equip2, int[][] equip3, int[][] equip4, int[][] equip5, String[] buff1, String[] buff2, String[] buff3, String[] buff4, String[] buff5, int[] powerEnemy, int[] powerPlayer, int powerSpdPlayer, int powerSpdEnemy, int HpCoefEnemy, int AtkCoefEnemy, int boss, int HpCoefBoss, int AtkCoefBoss, int levelSuppress, int levelSuppress2, int troopLoss, int[] specialCondition, int specialConditionDes, int powerLimit, String bgm){
        this.id = id;
        this.enemy1 = enemy1;
        this.enemy2 = enemy2;
        this.enemy3 = enemy3;
        ...
        this.scale4 = scale4;
        this.scale5 = scale5;
        this.zscale1 = zscale1;
        this.zscale2 = zscale2;
        this.zscale3 = zscale3;
        this.zscale4 = zscale4;
        this.zscale5 = zscale5;
        this.navy1 = navy1;
        this.navy2 = navy2;
        this.navy3 = navy3;
        this.navy4 = navy4;
