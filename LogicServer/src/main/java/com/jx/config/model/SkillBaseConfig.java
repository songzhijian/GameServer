...
import com.jx.config.loader.SkillBaseConfigLoader;
...
*/
public class SkillBaseConfig extends AbstractConfig implements IConfig {
    ...
    public static List<SkillBaseConfig> findAll(){
        return SkillBaseConfigLoader.findAll();
    }
    ...
    public static SkillBaseConfig getByKey(int key){
        return SkillBaseConfigLoader.getByKey(key);
    }
