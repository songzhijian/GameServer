...
import com.jx.config.model.SkillBaseExchangeConfig;
...
*/
@ConfigLoader
public class SkillBaseExchangeConfigLoader implements IConfigLoader{

    /**配置文件名*/
    public static final String CONFIG_NAME = "Skill_Base_Exchange";

    private static Map<Integer/*唯一Id*/, SkillBaseExchangeConfig> data = new HashMap<>();
    private static List<SkillBaseExchangeConfig> configs = new ArrayList<>();
    ...
    public static Map<Integer/*唯一Id*/, SkillBaseExchangeConfig> getData() {
        return data;
    }
    ...
    private static void load(){
        ...
        Map<Integer, SkillBaseExchangeConfig> tempMap = new HashMap<>();
        List<SkillBaseExchangeConfig> tempList = new ArrayList<>();
        Object errorId = null;
        ...
        for (Map<String, String> entry : all) {
            ...
            try {
                ...
                SkillBaseExchangeConfig config = new SkillBaseExchangeConfig(id, hero, position, stage, type, isSpecial, cost, condition, rangeType, range, targetType, targetParam, cd1, cd2, gcd, addPower, unstoppable, frontHalf, behindHalf, canBreak1, canBreak2, isResetCD, endFrame, movParam, param, isSing, isSpell, spellUltra);
